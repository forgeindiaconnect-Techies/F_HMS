...
import { 
    ...
    Compass, ShoppingBag, ChevronDown, Award, Play, RotateCcw, Volume2, VolumeX, CheckCircle2
} from 'lucide-react';
...
const ChaiTheoryShowcase = () => {
    ...
    const explodedThaliRef = useRef(null);
    const explodedSamosaRef = useRef(null);
    ...
    useEffect(() => {
        ...
        const ctx = gsap.context(() => {
            ...
            samosaTl
                .fromTo('.samosa-bg-box', { scale: 0.8, rotate: -5 }, { scale: 1.05, rotate: 0, duration: 1 })
                .fromTo('.samosa-spice-particle-1', { y: 100, opacity: 0 }, { y: -40, opacity: 1, duration: 0.8 }, 0.2)
                .fromTo('.samosa-spice-particle-2', { y: -80, opacity: 0 }, { y: 30, opacity: 1, duration: 0.8 }, 0.4);
            ...
            gsap.to(galleryCards, {
                ...
                scrollTrigger: {
                    ...
                    pin: true,
                    scrub: 1,
                    end: () => '+=' + document.querySelector('.horizontal-gallery-wrapper')?.offsetWidth
                }
            });
    ...
    return (
        <div ref={containerRef} className="w-full min-h-screen bg-[#FAFAF8] text-[#2B2320] font-sans relative overflow-x-hidden selection:bg-[#E38A2C] selection:text-white cursor-none">
            ...
            <div 
                ref={cursorRef} 
                className="fixed top-0 left-0 w-3 h-3 bg-[#E38A2C] rounded-full pointer-events-none z-[9999] -translate-x-1/2 -translate-y-1/2 shadow-lg hidden md:block" 
            />
            <div 
                ref={cursorFollowerRef} 
                className="fixed top-0 left-0 w-10 h-10 border-2 border-[#6B3F1D]/40 rounded-full pointer-events-none z-[9998] -translate-x-1/2 -translate-y-1/2 transition-transform duration-75 hidden md:block" 
            />

            {/* Subtle Film Grain Noise Texture Canvas Overlay */}
            <div 
            ...
            {/* ========================================================================= */}
            {!preloaderDone && (
                <div className="fixed inset-0 z-[10000] bg-[#FAFAF8] flex flex-col items-center justify-center p-6 text-center transition-opacity duration-500">
            ...
            <header className="fixed top-0 left-0 right-0 z-50 bg-[#FAFAF8]/90 backdrop-blur-xl border-b border-[#2B2320]/10 py-4 px-6 sm:px-12 flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                    <Link 
                        to="/menu"
                        className="bg-[#6B3F1D] hover:bg-[#2B2320] text-white font-extrabold text-xs px-5 py-2.5 rounded-xl shadow-lg shadow-[#6B3F1D]/20 hover:scale-105 active:scale-95 transition-all flex items-center gap-2"
                    >
                        <ShoppingBag size={14} />
                        <span>Order Now</span>
                    </Link>
            ...
            <section className="hero-section relative min-h-screen flex flex-col items-center justify-center px-6 pt-24 pb-16 overflow-hidden bg-[#FAFAF8]">
                ...
                <div className="relative z-10 max-w-5xl mx-auto text-center space-y-6 pt-12">
                    ...
                    {/* Subtitle */}
                    <p className="text-base sm:text-xl text-[#2B2320]/80 font-bold max-w-2xl mx-auto leading-relaxed drop-shadow-sm">
                    ...
                    {/* Built By Signature Tag */}
                    <div className="pt-2">
                        <span className="text-xs font-mono font-bold text-[#E38A2C] bg-[#E38A2C]/10 border border-[#E38A2C]/30 px-3.5 py-1.5 rounded-full inline-flex items-center gap-1.5">
                            <Heart size={12} className="fill-[#E38A2C]" /> Built By Ruturaj
                        </span>
                    </div>

                    {/* Pulsing Scroll Indicator */}
                    <div className="pt-12 flex flex-col items-center gap-2 text-xs font-bold text-[#6B3F1D]">
                        <span className="uppercase tracking-widest text-[10px]">SCROLL TO EXPLORE</span>
                        <ChevronDown size={20} className="animate-bounce text-[#E38A2C]" />
                    </div>
                </div>
            </section>
            ...
            <section className="coffee-section min-h-screen py-24 px-6 sm:px-12 bg-gradient-to-b from-[#FAFAF8] via-[#8A5A2B]/5 to-[#FAFAF8] flex items-center">
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="coffee-image-box relative rounded-[3rem] overflow-hidden shadow-2xl border-4 border-white bg-white group">
                        ...
                        />
                        <div className="absolute inset-0 bg-gradient-to-t from-[#8A5A2B]/80 via-transparent to-transparent" />
                    ...
                    <div className="space-y-8 text-left">
                        ...
                        <div className="grid grid-cols-3 gap-4 pt-4">
                            ...
                            <div className="bg-white p-5 rounded-2xl border border-[#8A5A2B]/20 shadow-md">
                                ...
                                <span className="text-xs font-bold text-[#2B2320]/70">Drip Brewed</span>
                            </div>
                            <div className="bg-white p-5 rounded-2xl border border-[#8A5A2B]/20 shadow-md">
            ...
            <section className="samosa-pin-container min-h-screen py-24 px-6 bg-gradient-to-b from-[#FAFAF8] via-[#C23B22]/5 to-[#FAFAF8] flex flex-col items-center justify-center text-center">
                <div className="max-w-5xl mx-auto space-y-6">
                    ...
                    <div className="samosa-bg-box relative max-w-3xl h-[400px] mx-auto rounded-[3rem] overflow-hidden border-4 border-white shadow-2xl bg-white my-8 flex items-center justify-center">
                        <img 
                            src="/assets/images/sweets-fusion.png" 
                            alt="Street Food Elevated"
                            className="w-full h-full object-cover"
                        />
                        <div className="absolute inset-0 bg-gradient-to-t from-[#C23B22]/70 via-transparent to-transparent" />
            ...
            <section className="relative py-32 px-6 bg-[#C23B22] text-white text-center overflow-hidden">
                <div className="relative z-10 max-w-4xl mx-auto space-y-8">
                    ...
                    <div className="pt-6 flex flex-col sm:flex-row items-center justify-center gap-4">
                        <Link 
                            to="/menu"
                            className="w-full sm:w-auto bg-white hover:bg-slate-100 text-[#C23B22] font-black text-base px-10 py-5 rounded-2xl shadow-2xl hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-3"
                        >
